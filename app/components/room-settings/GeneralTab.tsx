      ...
      <div className="min-h-0 flex-1 overflow-y-auto">
        ...
        <CardHeader>
          ...
          >
            ...
            {canAvatar && (
              <span className="absolute inset-0 flex items-center justify-center rounded-md bg-black/40 opacity-0 transition-opacity group-hover:opacity-100 [@media(hover:none)]:opacity-100 [@media(hover:none)]:bg-black/30">
